...
export const BENCHMARK_DATA: BenchmarkDataPoint[] = [
  ...
  // Growth funds
  {
    ...
    topQuartileTvpi: 2.1,
    medianTvpi: 1.1,
    bottomQuartileTvpi: 0.6,
    topQuartileIrr: 15,
    medianIrr: 4,
    bottomQuartileIrr: -10,
    sampleSize: 35,
  },
  {
    vintageYear: 2002,
...
function toBenchmarkType(
  fundType: import("./types").FundType,
  stage: FundStage,
): BenchmarkDataPoint["fundType"] {
...
function lookupBenchmark(
  benchType: BenchmarkDataPoint["fundType"],
  vintage: number,
...
export function getBenchmarkForFund(
  ...
  const proxyNote =
    vintageYear > 2021
      ? "Using 2021 vintage as proxy for recent fund."
      : undefined;

  return {
    benchmarkTvpi: {
      topQ: row.topQuartileTvpi,
      median: row.medianTvpi,
      bottomQ: row.bottomQuartileTvpi,
    },
    benchmarkIrr: {
      topQ: row.topQuartileIrr,
      median: row.medianIrr,
      bottomQ: row.bottomQuartileIrr,
    },
    playerTvpiPercentile: calcPercentile(
      playerTvpi,
      row.bottomQuartileTvpi,
      row.medianTvpi,
      row.topQuartileTvpi,
    ),
    playerIrrPercentile: calcPercentile(
      playerIrr,
      row.bottomQuartileIrr,
      row.medianIrr,
      row.topQuartileIrr,
    ),
