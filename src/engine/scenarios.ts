...
export const SCENARIOS: ScenarioConfig[] = [
  {
    ...
    description:
      "Standard 10-year venture fund lifecycle with no special constraints or win conditions. The original VenCap experience.",
    difficulty: "normal",
    fundOverrides: {},
    ...
    specialRules: [
      "Standard 10-year fund lifecycle",
  ...
  },
  {
    ...
    description:
      "You've just raised a $50M fund as the dot-com bubble is popping. Markets are crashing, LP sentiment is pessimistic, and every deal is suspect. Can you find the diamonds in the rubble and deliver a 2x return?",
    difficulty: "hard",
    fundOverrides: {
    ...
    winConditions: [
      {
        ...
        threshold: 2.0,
        byMonth: 120,
        description: "Achieve 2.0x TVPI by fund end",
      },
    ],
  ...
  },
  {
    ...
    name: "ZIRP Party",
    tagline:
      "Zero interest rates, infinite valuations. Don't get caught holding the bag.",
    description:
      "It's the free-money era — a $200M fund with bull markets and eager LPs. But valuations are insane, and you need to deliver 3x to be considered successful when the music stops.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 200_000_000,
      currentSize: 200_000_000,
      cashAvailable: 200_000_000,
    },
    ...
    winConditions: [
      {
        ...
        threshold: 3.0,
        byMonth: 120,
        description: "Achieve 3.0x TVPI by fund end",
      },
    ],
  ...
  },
  {
    ...
    description:
      "You've inherited a troubled fund in its 7th year with 5 pre-built struggling companies. The portfolio is underwater and LPs are restless. You have 3 years left to rescue what you can.",
    difficulty: "extreme",
    fundOverrides: {
    ...
    winConditions: [
      {
        ...
        threshold: 1.5,
        byMonth: 120,
        description: "Achieve 1.5x TVPI in remaining 3 years",
      },
    ],
  ...
  },
  {
    ...
    description:
      "A modest $20M first-time fund with limited brand recognition. You need to get your first exit within 5 years to build credibility for Fund II.",
    difficulty: "easy",
    fundOverrides: {
      targetSize: 20_000_000,
      currentSize: 20_000_000,
      cashAvailable: 20_000_000,
    },
    startingMarketCycle: "normal",
    ...
    winConditions: [
      {
        ...
        threshold: 1,
        byMonth: 60,
        description: "Achieve at least 1 exit within 5 years",
      },
    ],
  ...
  },
  {
    ...
    description:
      "A $150M buyout-focused fund. You favor control positions and operational improvement. Deliver 3x TVPI within 8 years by taking majority stakes and driving value creation.",
    difficulty: "normal",
    fundOverrides: {
      targetSize: 150_000_000,
      currentSize: 150_000_000,
      cashAvailable: 150_000_000,
    },
    startingMarketCycle: "normal",
    ...
    winConditions: [
      {
        ...
        threshold: 3.0,
        byMonth: 96,
        description: "Achieve 3.0x TVPI within 8 years",
      },
    ],
  ...
  },
  {
    ...
    description:
      "A tough market and 5 companies in distress. You need to rescue at least 3 of them to exits within 10 years. Triage, prioritize, and find the survivors.",
    difficulty: "extreme",
    fundOverrides: {
      targetSize: 80_000_000,
      currentSize: 80_000_000,
      cashAvailable: 25_000_000,
    },
    startingMarketCycle: "hard",
    ...
    winConditions: [
      {
        ...
        threshold: 3,
        byMonth: 120,
        description: "Get 3 of the 5 pre-built companies to successful exits",
      },
    ],
  ...
  },
  {
    ...
    description:
      "LP sentiment has collapsed to 15. You have 36 months to restore confidence to 60+ before they pull the plug. Every communication, every deal, every outcome matters.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 75_000_000,
      currentSize: 75_000_000,
    ...
    winConditions: [
      {
        ...
        threshold: 60,
        byMonth: 36,
        description: "Raise LP sentiment to 60+ within 3 years",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Your LPs are your lifeline. Maintain LP sentiment above 75 for at least 80% of the fund's lifetime. Every quarterly update, every co-invest opportunity, every exit announcement matters.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 100_000_000,
      currentSize: 100_000_000,
      cashAvailable: 100_000_000,
    },
    startingMarketCycle: "normal",
    startingLPSentiment: 50,
    startingMonth: 0,
    winConditions: [
      {
        type: "lp_sentiment_sustained",
        threshold: 75,
        byMonth: 120,
        description: "Keep LP sentiment above 75 for 80%+ of all months",
      },
    ],
    bonusScoreMultiplier: 1.5,
    specialRules: [
  ...
  },
  {
    ...
    description:
      "Prove that focus beats diversification. Invest in no more than 2 sectors and achieve a 3x portfolio MOIC. Deep expertise should yield outsized returns.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 80_000_000,
      currentSize: 80_000_000,
    ...
    winConditions: [
      {
        type: "sector_concentration_moic",
        threshold: 3.0,
        byMonth: 120,
        description: "Achieve 3.0x MOIC while investing in at most 2 sectors",
      },
    ],
    bonusScoreMultiplier: 1.6,
    specialRules: [
  ...
  },
  {
    ...
    description:
      "The best VCs see what others miss. Invest in at least 5 companies with initial traction below 30, and guide at least 2 of them to successful exits. Prove the doubters wrong.",
    difficulty: "extreme",
    fundOverrides: {
      targetSize: 60_000_000,
    ...
    winConditions: [
      {
        type: "contrarian_exits",
        threshold: 2,
        byMonth: 120,
        description:
          "Invest in 5+ low-traction companies (PMF < 30) and exit 2+ successfully",
      },
    ],
    bonusScoreMultiplier: 1.8,
    specialRules: [
  ...
  },
  {
    ...
    description:
      "Velocity is everything. Achieve 3 successful exits within the first 5 years. Find companies close to inflection points, add value quickly, and get liquidity events before others even deploy.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 75_000_000,
      currentSize: 75_000_000,
      cashAvailable: 75_000_000,
    },
    startingMarketCycle: "bull",
    startingLPSentiment: 60,
    startingMonth: 0,
    winConditions: [
      {
        ...
        threshold: 3,
        byMonth: 60,
        description: "Achieve 3 exits within the first 5 years",
      },
    ],
    bonusScoreMultiplier: 1.5,
    specialRules: [
  ...
  },
  {
    ...
    tagline:
      "Your network is your net worth. Build the ultimate co-investor web.",
    description:
      "Venture is a team sport. Co-invest with at least 8 different partners across your portfolio. Build the syndicate network that deal flow dreams are made of.",
    difficulty: "normal",
    fundOverrides: {
      targetSize: 120_000_000,
      currentSize: 120_000_000,
      cashAvailable: 120_000_000,
    },
    startingMarketCycle: "normal",
    startingLPSentiment: 55,
    startingMonth: 0,
    winConditions: [
      {
        type: "unique_coinvestors",
        threshold: 8,
        byMonth: 120,
        description:
          "Co-invest with 8+ different co-investors across your portfolio",
      },
    ],
    bonusScoreMultiplier: 1.3,
    specialRules: [
  ...
  },
  {
    ...
    description:
      "Prove that discipline beats spray-and-pray. Achieve a 2x net TVPI while deploying less than 60% of your fund. Every dollar must count.",
    difficulty: "hard",
    fundOverrides: {
      targetSize: 100_000_000,
      currentSize: 100_000_000,
    ...
    winConditions: [
      {
        ...
        byMonth: 120,
        description:
          "Achieve 2.0x net TVPI while deploying less than 60% of fund",
      },
    ],
    bonusScoreMultiplier: 1.5,
    specialRules: [
...
export function seedStartingPortfolio(
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const company: PortfolioCompany = {
      ...
      stage: "series_a",
      description:
        "Portfolio company requiring active management and strategic support.",
      founderName: founderNames[i],
      founderTraits: {
        grit: randomInt(4, 7),
        clarity: randomInt(3, 6),
        charisma: randomInt(3, 6),
        experience: randomInt(4, 7),
      },
      ...
      founderState: pickRandom([
        "distracted",
        "defensive",
        "burned_out",
      ] as const) as FounderState,
